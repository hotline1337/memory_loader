...
namespace hue
{
	...
	const std::map<std::string, int> CODES = {
		...
		{xorstr_("aqua"),             3}, {"a",   3},
		{xorstr_("red"),              4}, {"r",   4},
		{xorstr_("purple"),           5}, {"p",   5},
		{xorstr_("yellow"),           6}, {"y",   6},
		{xorstr_("white"),            7}, {"w",   7},
		{xorstr_("grey"),             8}, {"e",   8},
		{xorstr_("light blue"),       9}, {xorstr_("lb"),  9},
		{xorstr_("light green"),     10}, {xorstr_("lg"), 10},
		{xorstr_("light aqua"),      11}, {xorstr_("la"), 11},
		{xorstr_("light red"),       12}, {xorstr_("lr"), 12},
		{xorstr_("light purple"),    13}, {xorstr_("lp"), 13},
		{xorstr_("light yellow"),    14}, {xorstr_("ly"), 14},
		{xorstr_("bright white"),    15}, {xorstr_("bw"), 15}
	};
	...
	const std::map<int, std::string> NAMES = {
		...
		{ 7, xorstr_("white")},
		{ 8, xorstr_("grey")},
		{ 9, xorstr_("light blue")},
		{10, xorstr_("light green")},
		{11, xorstr_("light aqua")},
		{12, xorstr_("light red")},
		{13, xorstr_("light purple")},
		{14, xorstr_("light yellow")},
		{15, xorstr_("bright white")}
	};
